...
const App: React.FC = () => {
  ...
  const immediateRedirectLink = 'https://tg.pulse.is/envato265_bot?start=6828f8ba436d7292f30bf71e|utm_campaign=ENVATO2plfbLANDING';
  
  // ссылка на тгк для кнопки 
  const telegramLink = 'https://tg.pulse.is/envato265_bot?start=6828f8ba436d7292f30bf71e|utm_campaign=ENVATO2plfbLANDING'; 
  ...
  return (
    <div className="relative min-h-screen bg-black flex flex-col items-center justify-center p-4 overflow-hidden antialiased">
      ...
      >
        ...
        <h1 id="channel-title" className="text-2xl sm:text-3xl font-bold text-white">Envato 199грн/Місяць</h1>
        
        <p className="text-neutral-400 text-xs sm:text-sm">1,912 користувачів</p>
        
        <p className="text-neutral-400 text-xs sm:text-sm leading-relaxed px-2">
          Переходь до закритого бота, щоб дізнатися, де можна дешево придбати Envato Elements лише за 199грн/місяць
        </p>
